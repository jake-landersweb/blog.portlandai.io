    ...
    return <div className="w-screen">
        <div className="p-8 bg-cont border border-t-cont-200">
            <div className="grid place-items-center">
                ...
                <p className="text-txt-400 font-light text-center max-w-2xl">Welcome to our auto-blog, seamlessly blending traditional programming practices with advanced natural language models for autonomous operation. Dive deeper into our innovative process <a href="https://sapphirenw.com/auto-blog" className="underline hover:text-acc2" target="_blank" rel="noopener noreferrer">here</a>.</p>
            </div>
        </div>
        <div className="py-6 px-4 bg-gray-700 text-lt-400 flex items-center justify-between z-50">
            <span className="text-sm text-gray-300 sm:text-center">
                © 2023 <a className="hover:opacity-75" href="https://sapphirenw.com" target="_blank" rel="noopener noreferrer">Sapphire NW™</a>. All Rights Reserved.
            </span>
